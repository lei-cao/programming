/**
 * **************************************************************************** Compilation: javac
 * Point.java Execution: java Point Dependencies: none
 *
 * <p>An immutable data type for points in the plane. For use on Coursera, Algorithms Part I
...
public class Point implements Comparable<Point> {
  ...
  private static class SlopeOrder implements Comparator<Point> {
    ...
    public int compare(Point p1, Point p2) {
      ...
      if (Double.compare(slopeP1, slopeP2) < 0) {
        return -1;
      } else if (Double.compare(slopeP1, slopeP2) > 0) {
        return 1;
      } else {
        return 0;
      }
